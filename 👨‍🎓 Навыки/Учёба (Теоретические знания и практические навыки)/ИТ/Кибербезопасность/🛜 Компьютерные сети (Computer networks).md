...
#### Модель OSI
- [ ] [Модель OSI \| 7 уровней за 7 минут - YouTube](https://www.youtube.com/watch?v=je0QFU7p5Oo&t=78s) #YouTube 
- [ ] [Прикладной уровень \| Курс "Компьютерные сети" - YouTube](https://www.youtube.com/watch?v=l_MAOvAbYho) #AndreySozykin #YouTube 
- [ ] [Канальный уровень \| Курс "Компьютерные сети" - YouTube](https://www.youtube.com/watch?v=zYiKcbmBfgU) #AndreySozykin #YouTube 
- [ ] 
#### Модель TCP/IP
- [ ] [Модель и стек протоколов TCP/IP \| Курс "Компьютерные сети" - YouTube](https://www.youtube.com/watch?v=UZo4ffQ-aAc) #AndreySozykin #YouTube 
- [ ] [КАК УСТРОЕН TCP/IP? - YouTube](https://www.youtube.com/watch?v=EJzitviiv2c) #YouTube 

#### Протоколы
- [ ] [Протокол IMAP \| Курс "Компьютерные сети" - YouTube](https://www.youtube.com/watch?v=VGYHXIdtNS4) #AndreySozykin #YouTube
- [ ] [Протокол RIP \| Компьютерные сети. Продвинутые темы - YouTube](https://www.youtube.com/watch?v=LhvQoTsndRs) #AndreySozykin #YouTube
- [ ] [Протокол OSPF \| Компьютерные сети. Продвинутые темы - YouTube](ht#AndreySozykin //www.youtube.com/watch?v=rDPF5LZiyOw) #AndreySozykin #YouTube
- [ ] [Web сокеты \| Компьютерные сети. Продвинутые темы - YouTube](https://www.youtube.com/watch?v=TxVriqBkqbM) #AndreySozykin #YouTube
- [ ] 

#### HTTP
- [ ] [Протокол HTTP \| Курс "Компьютерные сети" - YouTube](https://www.youtube.com/watch?v=RlccXUx4LVw) #AndreySozykin #YouTube
- [ ] [Постоянное соединение в HTTP \| Курс "Компьютерные сети" - YouTube](https://www.youtube.com/watch?v=7DitlqcesKI) #AndreySozykin #YouTube
- [ ] [Кэширование в HTTP \| Курс "Компьютерные сети" - YouTube](https://www.youtube.com/watch?v=esi6YZRvJzk) #AndreySozykin #YouTube
- [ ] 


#### DNS
- [ ] [Протокол DNS \| Курс "Компьютерные сети" - YouTube](https://www.youtube.com/watch?v=yAlm-jTneeY) #AndreySozykin #YouTube
- [ ] [Система доменных имен DNS \| Курс "Компьютерные сети" - YouTube](https://www.youtube.com/watch?v=B0J0c0KLtbQ) #AndreySozykin #YouTube
- [ ] [Типы записей DNS \| Курс "Компьютерные сети" - YouTube](https://www.youtube.com/watch?v=mvMYV0Hfig4) #AndreySozykin #YouTube
- [ ] 
...
[Коммутаторы Ethernet \| Курс "Компьютерные сети" - YouTube](https://www.youtube.com/watch?v=bdbsPC3b09A) #AndreySozykin #YouTube

[Сервисы Wi-Fi \| Курс "Компьютерные сети" - YouTube](https://www.youtube.com/watch?v=FYAuqKjEpLs) #AndreySozykin #YouTube

[На каком уровне находится DHCP? \| Ответы на вопросы по компьютерным сетям - YouTube](https://www.youtube.com/watch?v=8awHbszHDAY) #AndreySozykin #YouTube

[Web сокеты \| Практика по компьютерным сетям - YouTube](https://www.youtube.com/watch?v=hA7fjYsuREc) #AndreySozykin #YouTube

[Протоколы маршрутизации \| Компьютерные сети. Продвинутые темы - YouTube](https://www.youtube.com/watch?v=MSg8gx3wnfQ) #AndreySozykin #YouTube

[IP адреса, часть 2 \| Курс "Компьютерные сети" - YouTube](https://www.youtube.com/watch?v=hSnXwFE0dqU) #AndreySozykin #YouTube

[Топологии сетей \| Курс "Компьютерные сети" - YouTube](https://www.youtube.com/watch?v=z8VmkYahV8M) #AndreySozykin #YouTube

[Протокол IP: маршрутизация \| Курс "Компьютерные сети" - YouTube](https://www.youtube.com/watch?v=kZqqk1tixfk) #AndreySozykin #YouTube

[MAC адреса \| Курс "Компьютерные сети" - YouTube](https://www.youtube.com/watch?v=WcdwSJrTFA0) #AndreySozykin #YouTube
