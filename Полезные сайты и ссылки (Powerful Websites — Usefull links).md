...
> 	- [Java курс от JavaRush — обучение программированию для начинающих](https://javarush.com/)
...
> 	- [Разработка информационных систем :: Sergey Drozdov](https://sd.blackball.lv/)
> 	- [Sololearn: Учитесь программировать](https://www.sololearn.com/ru/)
> 	- [scrimba.com](https://scrimba.com/home)
> 	- [freecodecamp.org Learn to Code — For Free — Coding Courses for Busy People](https://www.freecodecamp.org/)
> - JS ссылки на аню кубов и ее разработка игр
> - ссылки на ресурсы где нужно разрабатывать игры.. искать в избраном телеграма

>[!List]- Переводчики (Translators)
>- https://context.reverso.net/
>- [Google Переводчик](https://translate.google.com/?sl=en&tl=ru&op=translate)
>- [Lingvo Live. Translate from English, Russian, German, French, Spanish, Italian, Ukrainian.](https://www.lingvolive.com/en-us)

>[!List]- Словари (Dictionaries)
>- dmmodfgopfd
