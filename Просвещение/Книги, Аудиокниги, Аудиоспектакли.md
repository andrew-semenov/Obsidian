...
```dataviewjs
	...
	await dv.header(1, "<div id='testReading'>Читаю</div><div id='testListening'>Слушаю</div>");
	...
	*/
	...
	let testReading = document.getElementById("testReading");
	
	console.log("testReading", testReading);
	testReading.addEventListener("click", () => {
		//console.log("el", el);
		...
		let testListening = document.getElementById("testListening");
	
	console.log("testListening", testListening);
	testListening.addEventListener("click", () => {
		//console.log("el", el);
		document.getElementById("testListening").style.color = "gray";
		
		let listeningBooks = document.getElementsByClassName("listening");
