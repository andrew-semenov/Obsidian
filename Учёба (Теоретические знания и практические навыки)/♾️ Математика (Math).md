---
Описание: древнегреческое слово μαθηματικά (mathematiká), которое означает «изучение», «знание», «наука». Это слово происходит от корня μάθημα (máthēma). Термин был введен в древнегреческом языке, в том числе в работах Аристотеля, который использовал его для обозначения того, что мы сегодня называем математикой.
